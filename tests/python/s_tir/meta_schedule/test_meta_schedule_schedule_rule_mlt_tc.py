...
def test_matmul_relu(shared_scope):
                    ...
                    for ax2_0_0 in range(1):
                        for ax0_ax1_fused in range(4096):
                            with T.sblock("A_reindex_shared"):
                                ...
                                T.sblock_attr({"buffer_dim_align": [[0, 0, 32, 8]], "meta_schedule.cooperative_fetch": 8})
                        ...
                        for ax0_ax1_fused in range(4096):
                            with T.sblock("B_reindex_shared"):
                                ...
                                T.sblock_attr({"buffer_dim_align": [[0, 0, 32, 8]], "meta_schedule.cooperative_fetch": 1})
                                B_reindex_shared[v0, v1] = B[v0, v1]
                        for ax2_0_1 in range(4):
                            for ax0_0, ax1_0 in T.grid(2, 2):
                                with T.sblock("A_reindex_shared_wmma.matrix_a_o"):
                                    ...
                                    T.sblock_attr({"meta_schedule.auto_tensorize": f"maca_wmma_load_16x16x16_f16_a_{intrin_suffix}"})
                                    for ax0_1, ax1_1 in T.grid(16, 16):
                                        with T.sblock("A_reindex_shared_wmma.matrix_a"):
                            ...
                            for ax0_0, ax1_0 in T.grid(2, 1):
                                with T.sblock("B_reindex_shared_wmma.matrix_b_o"):
                                    ...
                                    T.sblock_attr({"meta_schedule.auto_tensorize": f"maca_wmma_load_16x16x16_f16_b_{intrin_suffix}"})
                                    for ax0_1, ax1_1 in T.grid(16, 16):
                                        with T.sblock("B_reindex_shared_wmma.matrix_b"):
                                            v0_i, v1_i = T.axis.remap("SS", [ax0_1, ax1_1])
                            ...
                            for ax0_0_3, ax1_0_3, ax2_0_2, ax0_0_4, ax1_0_4 in T.grid(1, 1, 2, 2, 1):
                                with T.sblock("C_o"):
                                    ...
                                    T.sblock_attr({"meta_schedule.auto_tensorize": "maca_wmma_sync_16x16x16_f16f16f32", "meta_schedule.auto_tensorize_init": "maca_wmma_fill_16x16x16_f32", "meta_schedule.thread_extent_high_inclusive": 1024, "meta_schedule.thread_extent_low_inclusive": 1, "warp_execution": 1})
                                    with T.init():
                                        for ax0_1, ax1_1 in T.grid(16, 16):
                ...
                for ax2 in range(2):
                    for ax0_ax1_fused in T.thread_binding(2, thread="threadIdx.y"):
                        for ax2_1, ax3 in T.grid(1, 1):
                            with T.sblock("C_reindex_shared_wmma.accumulator_o"):
                                ...
                                T.sblock_attr({"meta_schedule.auto_tensorize": f"maca_wmma_store_16x16x16_f32_{intrin_suffix}"})
    ...
    actual = generate_design_space(
        ...
        + get_rules(kind="maca-wmma", types=ms.schedule_rule.AutoInline),
    )
    check_sketches(
        mod,
        sketches=actual,
                    ...
                    for ax2_0_0 in range(2):
                        for ax0_ax1_fused in range(2048):
                            with T.sblock("A_reindex_shared"):
                                ...
                                T.reads(A[v0, v1])
                                T.writes(A_reindex_shared[v0, v1])
                                T.sblock_attr({"buffer_dim_align": [[0, 0, 32, 8]], "meta_schedule.cooperative_fetch": 4})
                                A_reindex_shared[v0, v1] = A[v0, v1]
                        for ax0_ax1_fused in range(8192):
                            with T.sblock("B_reindex_shared"):
                                ...
                                T.reads(B[v0, v1])
                                T.writes(B_reindex_shared[v0, v1])
                                T.sblock_attr({"buffer_dim_align": [[0, 0, 32, 8]], "meta_schedule.cooperative_fetch": 2})
                                B_reindex_shared[v0, v1] = B[v0, v1]
                        for ax2_0_1 in range(1):
                            for ax0_0, ax1_0 in T.grid(2, 4):
                                with T.sblock("A_reindex_shared_wmma.matrix_a_o"):
                                    ...
                                    T.reads(A_reindex_shared[v0_o * 16:v0_o * 16 + 16, v1_o * 16:v1_o * 16 + 16])
                                    T.writes(A_reindex_shared_wmma_matrix_a[v0_o * 16:v0_o * 16 + 16, v1_o * 16:v1_o * 16 + 16])
                                    T.sblock_attr({"meta_schedule.auto_tensorize": "maca_wmma_load_16x16x16_f16_a_shared"})
                                    for ax0_1, ax1_1 in T.grid(16, 16):
                                        with T.sblock("A_reindex_shared_wmma.matrix_a"):
                                            v0_i, v1_i = T.axis.remap("SS", [ax0_1, ax1_1])
                                            T.reads(A_reindex_shared[v0_o * 16 + v0_i, v1_o * 16 + v1_i])
                            ...
                            for ax0_0, ax1_0 in T.grid(4, 4):
                                with T.sblock("B_reindex_shared_wmma.matrix_b_o"):
                                    ...
                                    T.reads(B_reindex_shared[v0_o * 16:v0_o * 16 + 16, v1_o * 16:v1_o * 16 + 16])
                                    T.writes(B_reindex_shared_wmma_matrix_b[v0_o * 16:v0_o * 16 + 16, v1_o * 16:v1_o * 16 + 16])
                                    T.sblock_attr({"meta_schedule.auto_tensorize": "maca_wmma_load_16x16x16_f16_b_shared"})
                                    for ax0_1, ax1_1 in T.grid(16, 16):
                                        with T.sblock("B_reindex_shared_wmma.matrix_b"):
                                            v0_i, v1_i = T.axis.remap("SS", [ax0_1, ax1_1])
                                            T.reads(B_reindex_shared[v0_o * 16 + v0_i, v1_o * 16 + v1_i])
                    ...
                    for ax0_ax1_fused in T.thread_binding(2, thread="threadIdx.y"):
                        for ax2_1, ax3 in T.grid(1, 4):
                            with T.sblock("C_reindex_shared_wmma.accumulator_o"):
                                ...
                                T.reads(C_reindex_shared_wmma_accumulator[v0, v1, v2, v3, 0:16, 0:16])
                                T.writes(C_reindex_shared[v0, v1, v2, v3, 0:16, 0:16])
                                T.sblock_attr({"meta_schedule.auto_tensorize": "maca_wmma_store_16x16x16_f32_shared"})
                                for ax4, ax5 in T.grid(16, 16):
                                    with T.sblock("C_reindex_shared_wmma.accumulator"):
                                        v4_i, v5_i = T.axis.remap("SS", [ax4, ax5])
                                        T.reads(C_reindex_shared_wmma_accumulator[v0, v1, v2, v3, v4_i, v5_i])
            ...
            for ax0_0_1_ax1_0_1_fused in T.thread_binding(16, thread="blockIdx.x"):
                for ax0_0_2_ax1_0_2_fused in T.thread_binding(1, thread="threadIdx.y"):
                    for ax2_0_0 in range(1):
                        for ax0_ax1_fused in range(4608):
                            with T.sblock("PadInput_reindex_shared.dyn"):
                        ...
                        for ax0_ax1_fused in range(4608):
                            with T.sblock("weight_reindex_shared.dyn"):
                        ...
                        for ax2_0_1 in range(18):
                            for ax0_0, ax1_0 in T.grid(1, 1):
                                with T.sblock("PadInput_reindex_shared.dyn_wmma.matrix_a_o"):
                                    ...
                                    T.sblock_attr({"meta_schedule.auto_tensorize": f"maca_wmma_load_16x16x16_f16_a_{intrin_suffix}"})
                                    for ax0_1, ax1_1 in T.grid(16, 16):
                                        with T.sblock("PadInput_reindex_shared.dyn_wmma.matrix_a"):
                                            v0_i, v1_i = T.axis.remap("SS", [ax0_1, ax1_1])
                            ...
                            for ax0_0, ax1_0 in T.grid(1, 1):
                                with T.sblock("weight_reindex_shared.dyn_wmma.matrix_b_o"):
                                    ...
                                    T.sblock_attr({"meta_schedule.auto_tensorize": f"maca_wmma_load_16x16x16_f16_b_{intrin_suffix}"})
                                    for ax0_1, ax1_1 in T.grid(16, 16):
                                        with T.sblock("weight_reindex_shared.dyn_wmma.matrix_b"):
                                            v0_i, v1_i = T.axis.remap("SS", [ax0_1, ax1_1])
                ...
                for ax2 in range(1):
                    for ax0_ax1_fused in T.thread_binding(1, thread="threadIdx.y"):
                        for ax2_1, ax3 in T.grid(1, 1):
                            with T.sblock("conv2d_nhwc_reindex_shared.dyn_wmma.accumulator_o"):
                                ...
                                T.sblock_attr({"meta_schedule.auto_tensorize": f"maca_wmma_store_16x16x16_f32_{intrin_suffix}"})
                                for ax4, ax5 in T.grid(16, 16):
                                    with T.sblock("conv2d_nhwc_reindex_shared.dyn_wmma.accumulator"):
                                        v4_i, v5_i = T.axis.remap("SS", [ax4, ax5])
                    ...
                    for ax0_ax1_ax3_ax4_ax5_fused in range(256):
                        with T.sblock("conv2d_nhwc_reindex_shared.dyn"):
                    ...
                    for ax2_0_0 in T.serial(4, annotations={"software_pipeline_order": [0, 3, 1, 4, 5, 2, 6], "software_pipeline_stage": [0, 0, 0, 0, 0, 1, 1]}):
                        for ax0_ax1_fused in range(1024):
                            with T.sblock("A_reindex_shared"):
                                ...
                                T.reads(A[v0, v1])
                                T.writes(A_reindex_shared[v0, v1])
                                T.sblock_attr({"buffer_dim_align": [[0, 0, 32, 8]], "double_buffer_scope": 0, "meta_schedule.cooperative_fetch": 4, "tirx.manifest_shared_memory_local_stage": 1})
                                A_reindex_shared[v0, v1] = A[v0, v1]
                        for ax0_ax1_fused in range(1024):
                            with T.sblock("B_reindex_shared"):
                                ...
                                T.reads(B[v0, v1])
                                T.writes(B_reindex_shared[v0, v1])
                                T.sblock_attr({"buffer_dim_align": [[0, 0, 32, 8]], "double_buffer_scope": 0, "meta_schedule.cooperative_fetch": 2, "tirx.manifest_shared_memory_local_stage": 1})
                                B_reindex_shared[v0, v1] = B[v0, v1]
...
def test_matmul_relu_non_tensorizable():
    ...
    (sch,) = generate_design_space(
        ...
        + get_rules("maca-wmma", ms.schedule_rule.AutoInline),
    )
            ...
            for ax2_0_1_ax3_0_1_fused in T.thread_binding(1, thread="blockIdx.x"):
                for ax2_0_2_ax3_0_2_fused in T.thread_binding(2, thread="threadIdx.y"):
                    for ax4_0_0 in range(2):
                        for ax0_ax1_fused in range(8192):
                            with T.sblock("PadInput_reindex_shared"):
                        ...
                        for ax0_ax1_ax2_ax3_fused in range(2048):
                            with T.sblock("weight_reindex_shared"):
                                ...
                                T.sblock_attr({"buffer_dim_align": [[0, 2, 32, 8]], "meta_schedule.cooperative_fetch": 4})
                                weight_reindex_shared[v0, v1, v2, v3] = weight[v0, v1, v2, v3]
                        for ax4_0_1 in range(1):
                            for ax0_0, ax1_0 in T.grid(8, 2):
                                with T.sblock("PadInput_reindex_shared_wmma.matrix_a_o"):
                                    ...
                                    T.sblock_attr({"meta_schedule.auto_tensorize": "maca_wmma_load_16x16x16_f16_a_shared"})
                                    for ax0_1, ax1_1 in T.grid(16, 16):
                                        with T.sblock("PadInput_reindex_shared_wmma.matrix_a"):
                                            v0_i, v1_i = T.axis.remap("SS", [ax0_1, ax1_1])
                            ...
                            for ax0, ax1, ax2_0, ax3_0 in T.grid(1, 1, 2, 4):
                                with T.sblock("weight_reindex_shared_wmma.matrix_b_o"):
                                    ...
                                    for ax2_1, ax3_1 in T.grid(16, 16):
                                        with T.sblock("weight_reindex_shared_wmma.matrix_b"):
                ...
                for ax0_0_2_ax1_0_2_fused in T.thread_binding(8, thread="threadIdx.y"):
                    for ax2_0_0 in range(10):
                        for ax0_ax1_fused in range(28672):
                            with T.sblock("PadInput_reindex_pad_shared"):
                        ...
                        for ax0_ax1_fused in range(512):
                            with T.sblock("weight_reindex_pad_shared"):
                        ...
                        for ax2_0_1 in range(1):
                            for ax0_0, ax1_0 in T.grid(14, 1):
                                with T.sblock("PadInput_reindex_pad_shared_wmma.matrix_a_o"):
                                    ...
                                    T.sblock_attr({"meta_schedule.auto_tensorize": "maca_wmma_load_16x16x16_f16_a_shared"})
                                    for ax0_1, ax1_1 in T.grid(16, 16):
                                        with T.sblock("PadInput_reindex_pad_shared_wmma.matrix_a"):
                                            v0_i, v1_i = T.axis.remap("SS", [ax0_1, ax1_1])
                            ...
                            for ax0_0, ax1_0 in T.grid(1, 2):
                                with T.sblock("weight_reindex_pad_shared_wmma.matrix_b_o"):
                                    ...
                                    T.sblock_attr({"meta_schedule.auto_tensorize": "maca_wmma_load_16x16x16_f16_b_shared"})
                                    for ax0_1, ax1_1 in T.grid(16, 16):
                                        with T.sblock("weight_reindex_pad_shared_wmma.matrix_b"):
                                            v0_i, v1_i = T.axis.remap("SS", [ax0_1, ax1_1])
                            ...
                            for ax0_0_3, ax1_0_3, ax2_0_2, ax0_0_4, ax1_0_4 in T.grid(7, 2, 1, 2, 1):
                                with T.sblock("conv2d_nhwc_o"):
                                    ...
                                    T.sblock_attr({"meta_schedule.auto_tensorize": "maca_wmma_sync_16x16x16_f16f16f32", "meta_schedule.auto_tensorize_init": "maca_wmma_fill_16x16x16_f32", "meta_schedule.thread_extent_high_inclusive": 1024, "meta_schedule.thread_extent_low_inclusive": 64, "warp_execution": 1})
                                    with T.init():
                                        for ax0_1, ax1_1 in T.grid(16, 16):
                                            with T.sblock("conv2d_nhwc_init"):
                                                v0_i_init, v1_i_init = T.axis.remap("SS", [ax0_1, ax1_1])
                    ...
                    for ax2_0_0 in range(32):
                        ...
                        for ax2_0_1 in range(8):
                            for ax0_0, ax1_0 in T.grid(8, 1):
                                with T.sblock("A_reindex_pad_shared_wmma.matrix_a_o"):
                                    ...
                                    T.sblock_attr({"meta_schedule.auto_tensorize": "maca_wmma_load_16x16x16_f16_a_shared"})
                                    for ax0_1, ax1_1 in T.grid(16, 16):
                                        with T.sblock("A_reindex_pad_shared_wmma.matrix_a"):
                                            v0_i, v1_i = T.axis.remap("SS", [ax0_1, ax1_1])
                    ...
                    for ax0_ax1_fused in T.thread_binding(8, thread="threadIdx.y"):
                        for ax2_1, ax3 in T.grid(1, 2):
                            with T.sblock("C_reindex_pad_shared_wmma.accumulator_o"):
                                ...
                                T.sblock_attr({"meta_schedule.auto_tensorize": "maca_wmma_store_16x16x16_f32_shared"})
                                for ax4, ax5 in T.grid(16, 16):
                                    with T.sblock("C_reindex_pad_shared_wmma.accumulator"):
                                        v4_i, v5_i = T.axis.remap("SS", [ax4, ax5])
            ...
            for ax0_0_1_ax1_0_1_fused in T.thread_binding(2, thread="blockIdx.x"):
                for ax0_0_2_ax1_0_2_fused in T.thread_binding(4, thread="threadIdx.y"):
                    for ax2_0_0 in range(128):
                        ...
                        for ax0_ax1_fused in range(2048):
                            with T.sblock("B_reindex_pad_shared"):
                        ...
                        for ax2_0_1 in range(2):
                            ...
                            for ax0_0, ax1_0 in T.grid(1, 4):
                                with T.sblock("B_reindex_pad_shared_wmma.matrix_b_o"):
                                    ...
                                    T.sblock_attr({"meta_schedule.auto_tensorize": "maca_wmma_load_16x16x16_f16_b_shared"})
                                    for ax0_1, ax1_1 in T.grid(16, 16):
                                        with T.sblock("B_reindex_pad_shared_wmma.matrix_b"):
                                            v0_i, v1_i = T.axis.remap("SS", [ax0_1, ax1_1])
