...
macro(find_maca use_maca)
  ...
  set(MACA_INCLUDE_DIRS "")
  set(MACA_MACAMCC_LIBRARY "")
  set(MACA_HCA_LIBRARY "")
  set(MACA_FLASHATTN_LIBRARY "")

  set(__use_maca "${use_maca}")
  if(IS_DIRECTORY "${__use_maca}")
    set(__maca_sdk "${__use_maca}")
    message(STATUS "Custom MACA SDK PATH=" ${__use_maca})
  elseif(DEFINED ENV{MACA_PATH} AND IS_DIRECTORY "$ENV{MACA_PATH}")
  ...
  if(__maca_sdk)
    ...
    if(IS_DIRECTORY "${MACA_INCLUDE_DIRS}" AND MACA_MACAMCC_LIBRARY)
      set(MACA_FOUND TRUE)
    else()
