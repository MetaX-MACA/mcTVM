...
# ruff: noqa: E501
"""Conv2d kernel generator and profiler for MCTLASS."""
...
def create_conv2d_operator_with_epilogue(
    ...
    if "residual" in op_type:
        activation_map = {
            "mctlass.conv2d_bias_hardswish": "mctlass::epilogue::thread::HardSwish",
            "mctlass.conv2d_bias_silu": "mctlass::epilogue::thread::SiLu",
            "mctlass.conv2d_bias_sigmoid": "mctlass::epilogue::thread::Sigmoid",
            "mctlass.conv2d_bias_relu": "mctlass::epilogue::thread::ReLu",
            "mctlass.conv2d_bias": "mctlass::epilogue::thread::Identity",
        }
