...
# under the License.
"""External function interface to McDNN v7 library."""
...
def algo_to_index(algo_type, algo_name):
    ...
    ----------
        ...
        algo_name : str
            algorithm name in mcdnn definition
            fwd = [
                "MCDNN_CONVOLUTION_FWD_ALGO_IMPLICIT_GEMM",
                "MCDNN_CONVOLUTION_FWD_ALGO_IMPLICIT_PRECOMP_GEMM",
                "MCDNN_CONVOLUTION_FWD_ALGO_GEMM",
            ...
            bwd_data = [
                ...
                "MCDNN_CONVOLUTION_BWD_DATA_ALGO_COUNT",
            ]
