...
Mirrors the MACA copy register partition: the partition is *induced* by the layout that
...
# -----------------------------------------------------------------------------
# Emit — packed (one scalar call per outer chunk; no T.vectorized inside)
# -----------------------------------------------------------------------------
