...
#ifndef TVM_S_TIR_META_SCHEDULE_SCHEDULE_RULE_H_
...
class ScheduleRule : public ffi::ObjectRef {
 public:
  ...
  TVM_DLL static ffi::Array<ScheduleRule, void> DefaultMACA();
  /*! \brief Create default postprocessors for MACA with WMMA */
  TVM_DLL static ffi::Array<ScheduleRule, void> DefaultMACAWMMA();
