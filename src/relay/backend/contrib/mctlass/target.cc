...
/*!
 * \file src/relay/backend/contrib/mctlass/target.cc
 * \brief Registers the "mctlass" external codegen TargetKind.
 */
 ...
 * TVM's 3rdparty/mctlass.
 *  - Patterns: python/tvm/relay/op/contrib/mctlass.py
 *  - Custom compiler: python/tvm/contrib/mctlass/build.py,
 *                     src/relay/backend/contrib/mctlass/codegen.cc
 */
TVM_REGISTER_TARGET_KIND("mctlass", kDLMACA)
