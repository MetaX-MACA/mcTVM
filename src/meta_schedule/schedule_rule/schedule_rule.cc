...
TVM_FFI_REGISTER_GLOBAL("meta_schedule.ScheduleRuleDefaultMACA")
    .set_body_typed(ScheduleRule::DefaultMACA);
TVM_FFI_REGISTER_GLOBAL("meta_schedule.ScheduleRuleDefaultMACAWMMA")
    .set_body_typed(ScheduleRule::DefaultMACAWMMA);
