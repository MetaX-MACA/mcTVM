...
TVM_REGISTER_GLOBAL("tvm.contrib.mcdnn.conv2d.backward_data")
...
TVM_REGISTER_GLOBAL("tvm.contrib.mcdnn.conv.backward_data_find_algo")
    .set_body([](TVMArgs args, TVMRetValue* ret) {
      int format = args[0];
      int dims = args[1];
...
TVM_REGISTER_GLOBAL("tvm.contrib.mcdnn.conv2d.backward_filter")
    .set_body([](TVMArgs args, TVMRetValue* ret) {
      int mode = args[0];
      int format = args[1];
      int algo = args[2];
...
TVM_REGISTER_GLOBAL("tvm.contrib.mcdnn.conv.backward_filter_find_algo")
    .set_body([](TVMArgs args, TVMRetValue* ret) {
      int format = args[0];
      int dims = args[1];
      int* pad = static_cast<int*>(static_cast<void*>(args[2]));
