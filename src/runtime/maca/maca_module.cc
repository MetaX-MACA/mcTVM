...
PackedFunc MACAModuleNode::GetFunction(const String& name, const ObjectPtr<Object>& sptr_to_self) {
...
TVM_REGISTER_GLOBAL("runtime.module.loadbinary_mcir").set_body_typed(MACAModuleLoadBinary);

TVM_REGISTER_GLOBAL("runtime.module.loadbinary_maca").set_body_typed(MACAModuleLoadBinary);
TVM_REGISTER_GLOBAL("runtime.module.loadbinary_mc").set_body_typed(MACAModuleLoadBinary);

TVM_REGISTER_GLOBAL("runtime.module.loadfile_mcir").set_body_typed(MACAModuleLoadFile);
TVM_REGISTER_GLOBAL("runtime.module.loadfile_maca").set_body_typed(MACAModuleLoadFile);
TVM_REGISTER_GLOBAL("runtime.module.loadfile_mcbin").set_body_typed(MACAModuleLoadFile);
}  // namespace runtime
}  // namespace tvm
