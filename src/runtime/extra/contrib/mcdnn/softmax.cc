...
void softmax_impl(mcdnnSoftmaxAlgorithm_t alg, ffi::PackedArgs args, ffi::Any* ret) {
...
TVM_FFI_STATIC_INIT_BLOCK() {
  ...
  refl::GlobalDef()
      .def_packed("tvm.contrib.mcdnn.softmax.forward",
                  [](ffi::PackedArgs args, ffi::Any* ret) {
                    softmax_impl(MCDNN_SOFTMAX_ACCURATE, args, ret);
                  })
      .def_packed("tvm.contrib.mcdnn.log_softmax.forward", [](ffi::PackedArgs args, ffi::Any* ret) {
        softmax_impl(MCDNN_SOFTMAX_LOG, args, ret);
      });
}
