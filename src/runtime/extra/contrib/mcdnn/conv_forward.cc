...
TVM_FFI_STATIC_INIT_BLOCK() {
  ...
  refl::GlobalDef()
      .def_packed("tvm.contrib.mcdnn.conv2d.forward",
      ...
      .def_packed("tvm.contrib.mcdnn.conv2d+bias+act.forward",
                  [](ffi::PackedArgs args, ffi::Any* ret) {
                    int mode = args[0].cast<int>();
                    int format = args[1].cast<int>();
                    int algo = args[2].cast<int>();
      ...
      .def_packed("tvm.contrib.mcdnn.conv3d.forward",
                  [](ffi::PackedArgs args, ffi::Any* ret) {
                    int mode = args[0].cast<int>();
                    int format = args[1].cast<int>();
                    int algo = args[2].cast<int>();
      ...
      .def_packed("tvm.contrib.mcdnn.conv.forward_find_algo",
                  [](ffi::PackedArgs args, ffi::Any* ret) {
