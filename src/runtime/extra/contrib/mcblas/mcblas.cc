...
/*!
 * \file Use external mcblas library call.
 */
...
inline void CallLtIgemm(ffi::PackedArgs args, ffi::Any* ret, mcblasLtHandle_t hdl,
                        mcStream_t stream) {
...
inline void CallGemmEx(ffi::PackedArgs args, ffi::Any* ret, mcblasHandle_t hdl) {
  auto A = args[0].cast<DLTensor*>();
  auto B = args[1].cast<DLTensor*>();
  auto C = args[2].cast<DLTensor*>();
  bool transa = args[3].cast<bool>();
...
inline void CallBatchGemmEx(ffi::PackedArgs args, ffi::Any* ret, mcblasHandle_t hdl) {
  auto A = args[0].cast<DLTensor*>();
  auto B = args[1].cast<DLTensor*>();
  auto C = args[2].cast<DLTensor*>();
  bool transa = args[3].cast<bool>();
...
TVM_FFI_STATIC_INIT_BLOCK() {
  ...
  refl::GlobalDef().def_packed(
      "tvm.contrib.mcblas.matmul", [](ffi::PackedArgs args, ffi::Any* ret) {
        auto A = args[0].cast<DLTensor*>();
        auto C = args[2].cast<DLTensor*>();

        McBlasThreadEntry* entry_ptr = McBlasThreadEntry::ThreadLocal(A->device);
...
TVM_FFI_STATIC_INIT_BLOCK() {
  namespace refl = tvm::ffi::reflection;
  refl::GlobalDef().def_packed("tvm.contrib.mcblaslt.matmul", [](ffi::PackedArgs args,
                                                                 ffi::Any* ret) {
    auto A = args[0].cast<DLTensor*>();
...
TVM_FFI_STATIC_INIT_BLOCK() {
  namespace refl = tvm::ffi::reflection;
  refl::GlobalDef().def_packed(
      "tvm.contrib.mcblas.batch_matmul", [](ffi::PackedArgs args, ffi::Any* ret) {
        auto A = args[0].cast<DLTensor*>();
        auto C = args[2].cast<DLTensor*>();
