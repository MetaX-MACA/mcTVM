...
ffi::Array<Postproc> Postproc::DefaultMACA() {
  return ffi::Array<Postproc>{
      Postproc::DisallowDynamicLoop(),
      Postproc::RewriteCooperativeFetch(),
      Postproc::RewriteUnboundBlock(/*max_threadblocks=*/256),
...
ffi::Array<Postproc> Postproc::DefaultMACAWMMA() {
  return ffi::Array<Postproc>{
      Postproc::DisallowDynamicLoop(),
      Postproc::RewriteCooperativeFetch(),
      Postproc::RewriteUnboundBlock(/*max_threadblocks=*/256),
...
TVM_FFI_STATIC_INIT_BLOCK() {
  ...
  refl::GlobalDef()
      ...
      .def("s_tir.meta_schedule.PostprocDefaultMACA", Postproc::DefaultMACA)
      .def("s_tir.meta_schedule.PostprocDefaultMACAWMMA", Postproc::DefaultMACAWMMA)
