...
ffi::Array<ScheduleRule> ScheduleRule::DefaultMACA() {
  return {
      ScheduleRule::ApplyCustomRule(),
      ScheduleRule::MultiLevelTiling(
          /*structure=*/"SSSRRSRS",
      ...
      ScheduleRule::ParallelizeVectorizeUnroll(
          /*max_jobs_per_core=*/-1,
          /*max_vectorize_extent=*/-1,
          /*unroll_max_steps=*/ffi::Array<int64_t>{0, 16, 64, 512, 1024},
          /*unroll_explicit=*/true),
      ScheduleRule::AutoBind(
...
ffi::Array<ScheduleRule> ScheduleRule::DefaultMACAWMMA() {
  ffi::Array<ffi::Map<ffi::String, ffi::String>> wmma_intrin_groups = {
      {
  ...
  ffi::Array<ScheduleRule> append = ScheduleRule::DefaultMACA();
  results.insert(results.end(), append.begin() + 1, append.end());
  return results;
}
...
TVM_FFI_STATIC_INIT_BLOCK() {
  ...
  refl::GlobalDef()
      ...
      .def("s_tir.meta_schedule.ScheduleRuleDefaultMACA", ScheduleRule::DefaultMACA)
      .def("s_tir.meta_schedule.ScheduleRuleDefaultMACAWMMA", ScheduleRule::DefaultMACAWMMA)
