...
ffi::Map<Mutator, FloatImm> Mutator::DefaultMACA() {
  return ffi::Map<Mutator, FloatImm>{
      {Mutator::MutateTileSize(), FloatImm(PrimType::Float(64), 0.9)},
      {Mutator::MutateUnroll(), FloatImm(PrimType::Float(64), 0.08)},
      {Mutator::MutateThreadBinding(), FloatImm(PrimType::Float(64), 0.02)}};
...
ffi::Map<Mutator, FloatImm> Mutator::DefaultMACAWMMA() { return Mutator::DefaultMACA(); }
...
TVM_FFI_STATIC_INIT_BLOCK() {
  ...
  refl::GlobalDef()
      ...
      .def("s_tir.meta_schedule.MutatorDefaultMACA", Mutator::DefaultMACA)
      .def("s_tir.meta_schedule.MutatorDefaultMACAWMMA", Mutator::DefaultMACAWMMA)
