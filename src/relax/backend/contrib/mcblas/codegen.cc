...
class McblasJSONSerializer : public JSONSerializer {
 public:
  McblasJSONSerializer(Map<Constant, String> constant_names, Map<Var, Expr> bindings)
...
Array<runtime::Module> McblasCompiler(Array<Function> functions, Map<String, ObjectRef> /*unused*/,
  ...
  for (const auto& func : functions) {
    ...
    const auto* pf = runtime::Registry::Get("runtime.McblasJSONRuntimeCreate");
    ICHECK(pf != nullptr) << "Cannot find MCBLAS runtime module create function.";
...
TVM_REGISTER_GLOBAL("relax.ext.mcblas").set_body_typed(McblasCompiler);
